    ...
    <div className={style.footer_section}>
      <div className={style.footer_section_content}>
        ...
        <div className={style.footer_text}>
          <p className={style.footer_first_text}>
            Copyright © 2022 OpenTempus Protocol a Series of LF Projects, LLC.
          </p>
          <p className={style.footer_second_text}>
            OpenTempus is a trademark of LF Projects, LLC. For trademark usage
            guidelines and other applicable policies, please see
            www.lfprojects.org.
          </p>
        </div>
      </div>
